...
export const productFiles: ProductFile[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Sends a few warm, polite follow-ups that you approve first",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Shown 24,000 times on Google · 550 visits · average spot 7.2, all in six months",
  ...
  },
  {
    ...
    cta: {
      label: "Partner with Bloom Co on WhatsApp",
      href: "https://wa.me/251725145079",
  ...
  },
  {
    ...
    status: "Working Beta",
    paragraphs: [
      "Tayoo puts all of Addis Ababa's transport into one app: trains, buses, and minibuses. It works in Amharic and English, even without internet. It answers the three questions every commuter asks: how do I get there, what will it cost, and what's going on out there?",
    ],
    sections: [
      {
        heading: "The problem it solves",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Reports checked by riders who are actually there, so fakes don't work",
    ...
    images: [
      {
        src: "/images/products/tayoo/tayoo-home-planner.jpg",
        alt: "Tayoo home screen with the Find Your Route planner in Amharic and English",
        width: 1080,
        height: 2129,
        caption: "Plan a trip in Amharic or English, with saved places one tap away",
      },
      {
        src: "/images/products/tayoo/tayoo-home-news.jpg",
        alt: "Tayoo home screen showing breaking transport news cards and a partner offer",
        width: 1080,
        height: 2129,
        caption: "Live transport news on the home screen, with partner offers",
      },
      {
        src: "/images/products/tayoo/tayoo-news-article.jpg",
        alt: "A Tayoo news article with an English and Amharic language toggle",
        width: 1080,
        height: 2129,
        caption: "Every story opens in English or Amharic with one tap",
      },
      {
        src: "/images/products/tayoo/tayoo-live-feed.jpg",
        alt: "Tayoo live feed of rider reports with locations and confirmation buttons",
        width: 1080,
        height: 2129,
        caption: "The live feed: riders report what's happening on the road",
      },
      {
        src: "/images/products/tayoo/tayoo-live-feed-verified.jpg",
        alt: "Tayoo live feed showing rider reports earning verified badges",
        width: 1080,
        height: 2129,
        caption: "A report earns its verified badge only after other riders confirm it",
      },
      {
        src: "/images/products/tayoo/tayoo-wallet.jpg",
        alt: "Tayoo wallet showing total transport spending for the month and a budget option",
        width: 1080,
        height: 2129,
        caption: "The wallet shows what you spent this month, in birr",
      },
      {
        src: "/images/products/tayoo/tayoo-wallet-insights.jpg",
        alt: "Tayoo commute insights with daily average, monthly forecast, and recent trips",
        width: 1080,
        height: 2129,
        caption: "Daily average, monthly forecast, and every trip logged",
      },
      {
        src: "/images/products/tayoo/tayoo-profile.jpg",
        alt: "Tayoo rider profile with trust score, total trips, day streak, and CO2 saved",
        width: 1080,
        height: 2129,
        caption: "A rider profile: trust score, trips, streak, and CO2 saved",
      },
      {
        src: "/images/products/tayoo/tayoo-profile-badges.jpg",
        alt: "Tayoo impact stats and badges earned by riding and reporting",
        width: 1080,
        height: 2129,
        caption: "Impact stats and badges reward riders who keep the map accurate",
      },
      {
        src: "/images/products/tayoo/tayoo-profile-settings.jpg",
        alt: "Tayoo badges and settings screen in Amharic and English",
        width: 1080,
        height: 2129,
        caption: "Bilingual to the last screen, settings included",
      },
    ],
    highlights: [
  ...
  },
  {
    ...
    paragraphs: [
      "AutoLink works on Telegram, so there is no app to install. A garage, fleet, or car owner sends one message: typed, spoken, or a photo of the part. Back come up to three options a real seller has just confirmed: the grade, a price range, a fresh photo, a trust score, and when it was last checked.",
    ...
    cta: {
      label: "Join the Addis pilot on WhatsApp",
      href: "https://wa.me/251725145079",
